...
// Cambiado para usar variables de entorno de Vercel/Vite
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-[3rem] w-full max-w-sm overflow-hidden shadow-2xl border-4 border-white">
            <div className="p-8 text-center" style={{ backgroundColor: COLORS.blush }}>
              ...
              <h2 className="text-2xl font-black leading-tight" style={{ color: COLORS.raspberryRose }}>¿Cómo encargar?</h2>
            </div>
            <div className="p-8 space-y-5">
              <div className="flex gap-4 items-start">
                ...
                <p className="text-sm font-medium leading-relaxed">Anticipo del <b>50%</b> para agendar.</p>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <p className="text-sm font-medium leading-relaxed">No hay devolución de anticipo en cancelaciones.</p>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <p className="text-sm font-medium leading-relaxed">El tiempo de entrega varía según el diseño.</p>
              </div>
            </div>
            <button onClick={() => setShowInfo(false)} className="w-full py-5 text-white font-black text-lg" style={{ backgroundColor: COLORS.raspberryRose }}>¡Entendido! ♡</button>
          </div>
        </div>
      )}
